            ...
            <div class="row" style="background-color: #00509d; height: 200px; padding: 35px; color: white;">
                <div class="container-fluid">
                    <h3 class="m-0 p-0 mt-4" style="margin-top: 0; font-size: 28px; font-weight: 500;">
                        <strong style="font-size: 32px;">Thông báo đặt hàng</strong>
                        <br>
                        Thank you very much
                    </h3>
                    ...
                    <tr>
                        ...
                        @if($order->payment_type == "online_payment")
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                      style="color:#424853; font-family:trebuchet,sans-serif; font-size:16px; font-weight:normal; line-height:22px;">
                                      Đơn hàng của bạn đã được thanh toán trực tuyến. Chúng tôi vừa bàn giao đơn hàng của bạn cho đối tác vận chuyển.                                </span>
                            </td>
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        <p>Bạn có thể kiểm tra hình thức bên ngoài của sản phẩm (nhãn hiệu, mẫu mã, màu sắc, số lượng,...) trước khi
                        ...
                        <p>Nếu sản phẩm có dấu hiệu hư hỏng/hỏng hoặc không khớp với thông tin trên
                        ...
                        <p>Bạn có thể tham khảo trang Trung tâm trợ giúp hoặc liên hệ với cửa hàng bằng cách để lại tin nhắn tại
                            Trang liên hệ hoặc gửi thư tại đây. HOTLINE 1900 9999 (8h00 - 9h00 cả thứ 7 và chủ nhật).</p>

                        <b>tqn ShoesShop thank you.</b>
                    </div>
                </div>
            </div>
