                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-7">
                                ...
                                <form action="">
                                    ...
                                    <select name="sort_by" onchange="this.form.submit();" class="sorting" name="" id="">
                                        ...
                                        <option {{ request('sort_by') == 'price-descending' ? 'selected' : '' }} value="price-descending">Sorting: Price Decreasing</option>
                                    </select>
