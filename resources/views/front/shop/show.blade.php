                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="tab-2" role="tabpanel">
                                        <div class="specification-table">
                                            <table>
                                                <tr>
                                                    <td class="p-catagory">Custumer Rating</td>
                                                    <td>
                                                        <div class="pd-rating">
                                                            @for($i = 1; $i <= 5; $i++)
                                                                @if($i <= $product->avgRating)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="p-price">{{ $product->price }}đ</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="p-catagory">Available</td>
                                                    <td>
...
{{--                                                        {{ date('M d, Y', strtotime($productComment->create_at)) }}--}}
