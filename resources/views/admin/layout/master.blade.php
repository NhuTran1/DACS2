...
<head>
    ...
    <title>@yield('title') | Admin ShoesShop</title>
    <meta name="viewport"
          content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no" />
    <meta name="description"
          content="Bảng điều khiển">
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    ...
    <div class="app-header header-shadow">
        <div class="app-header__logo">
            <div><img src="./dashboard/assets/images/logo.png"></div>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-right mr-2">
                                                                <a href="./admin/logout" class="btn-pill btn-shadow btn-hover-shine btn btn-focus">
                                                                    Logout
                                                                </a>
                                                            </div>
                                                        </div>
            ...
            <div class="scrollbar-sidebar">
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            <a href="./admin" class="{{ (request()->segment(2) == 'home') ? 'mm-active' : '' }}">
                        ...
                        <li>
                            <a href="./admin/category" class="{{ (request()->segment(2) == 'category') ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-albums "></i>Category
                                <i class="metismenu-state-icon caret-left"></i>
                            </a>
                        </li>
                        <li>
                            <a href="./admin/brand" class="{{ (request()->segment(2) == 'brand') ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-server"></i>Brand
                                <i class="metismenu-state-icon caret-left"></i>
                            </a>
                        </li>
                        <li>
                            <a href="./admin/product" class="{{ (request()->segment(2) == 'product') ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-plugin"></i>Product
                                <i class="metismenu-state-icon caret-left"></i>
                            </a>
                        </li>
                        <li>
                            <a href="./admin/order" class="{{ (request()->segment(2) == 'order') ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-cart "></i>Order
                                <i class="metismenu-state-icon caret-left"></i>
                            </a>
                        </li>

                        <li class="mm-active">
                            <a href="#" class="{{ (request()->segment(2) == 'other') ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-keypad"></i>Others
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="./admin/contact" class="{{ (request()->segment(2) == 'contact') ? 'mm-active' : '' }}" class="{{ (request()->segment(2) == 'contact') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Contacts
                                    </a>
                                </li>
                                <li>
                                    <a href="./admin/review" class="{{ (request()->segment(2) == 'review') ? 'mm-active' : '' }}" class="{{ (request()->segment(2) == 'review') ? 'mm-active' : '' }}">
